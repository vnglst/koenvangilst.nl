  ...
  <footer>
    ...
    <div className="footer-content">
      <span className="social-links">
        ...
        >
          <i className="fa fa-lg fa-twitter" style={{ color: '#4099FF' }} />Twitter
        </a>
        <a
          target="_blank"
        ...
        >
          <i className="fa fa-lg fa-github" style={{ color: '#36382E' }} />GitHub
        </a>
        <a
          target="_blank"
        ...
        >
          <i className="fa fa-lg fa-linkedin" style={{ color: '#007BB6' }} />LinkedIn
        </a>
      </span>
