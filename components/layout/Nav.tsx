...
export function Nav() {
  return (
    <nav className="bg-opacity-80 dark:bg-opacity-80 fixed top-0 right-0 left-0 z-10 flex items-center justify-start gap-4 bg-slate-50 p-4 backdrop-blur-sm backdrop-saturate-150 md:px-8 dark:bg-slate-950">
      <a
        href="#content"
