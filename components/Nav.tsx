...
export function Nav() {
  return (
    <nav className="sticky top-0 z-10 flex items-center justify-start gap-4 bg-white bg-opacity-80 p-4 backdrop-saturate-50 md:px-8 dark:bg-black dark:bg-opacity-80">
      <a
        href="#content"
