...
Some great other tips in that thread and I'm summerizing them here for future reference.
...
Now instead of using `rm -rf node_modules` you can now use `trash node_modules`.
