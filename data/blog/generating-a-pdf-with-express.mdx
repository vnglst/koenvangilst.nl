...
summary: A fun little tutorial of how to create a PDF using a web form, Express and PDFKit
---

In this article you'll find a fun little tutorial of how to create a PDF file using a web form, Express and PDFKit. To get started it'll use the express generator and after completing it you'll have a simple web form that generates a PDF file if the user clicks on the button _Create PDF_. I'll also point you in the right direction if you want to deploy the app using [Now](https://zeit.co/now).

![Screenshot endresult](/static/images/form-pdf.png)
...
I hope you enjoyed this tutorial and feel free to ask me any questions. You can also deploy your own Form to PDF app using Now. It's easy and takes only a few seconds. Instructions can be found [here](https://zeit.co/now).
