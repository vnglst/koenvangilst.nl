...
In this tutorial I'll go over the steps needed to retrieve, prepare and visualise the data in an Elixir Livebook. At the end of this tutorial you should be able to visualize the average age of politicians of other countries as well. The corresponding Livebook can be found [here](https://github.com/vnglst/livebook-age-of-dutch-parliament/blob/main/age-of-parliament.livemd).
