...
I'll leave out the front-end code in this tutorial as it is quite straightforward. For those interested in how it works it's a combination of a [React component](https://github.com/vnglst/koenvangilst.nl/edit/main/app/(default)/dashboard/co2/(components)/Co2Monitor.tsx) and a Next.JS api route that calls the following [service](https://github.com/vnglst/koenvangilst.nl/blob/main/services/aranet.ts). 
