...
[^1]:
    ...
    the Phoenix primitives like Channels and Presence, before I start with
    LiveView. In the future I would like to build the same functionality
    again with LiveView to see how it would reduce complexity.
