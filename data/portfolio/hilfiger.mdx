...
name: Tommy Hilfiger
year: 2017
summary: For Tommy Hilfiger I worked as a fullstack JavaScript developer on their loyality app MyTommy. The app is build in React Native for both iPhone and Android, with a restful Node/Express API on the backend.
---

For Tommy Hilfiger I worked in an Agile Scrum team as a fullstack
JavaScript developer on their loyality app **MyTommy**. I worked on
...
<Image
  alt={``}
  src={`/static/screenshots/mytommy1.PNG`}
  width={1242 / 4}
  height={2208 / 4}
/>
<Image
  alt={``}
  src={`/static/screenshots/mytommy2.PNG`}
  width={1242 / 4}
  height={2208 / 4}
/>
<Image
  alt={``}
  src={`/static/screenshots/mytommy3.PNG`}
  width={1242 / 4}
  height={2208 / 4}
/>
<Image
  alt={``}
  src={`/static/screenshots/mytommy4.PNG`}
  width={1242 / 4}
  height={2208 / 4}
/>
<Image
  alt={``}
  src={`/static/screenshots/mytommy5.PNG`}
  width={1242 / 4}
  height={2208 / 4}
/>
<Image
  alt={``}
  src={`/static/screenshots/mytommy6.PNG`}
  width={1242 / 4}
  height={2208 / 4}
/>
