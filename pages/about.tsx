    ...
    <Container title="About – Koen van Gilst" type="article">
      <article className="flex flex-col items-start justify-center w-full max-w-2xl mx-auto mb-16">
        ...
        <article className="mb-4 prose leading-6 text-gray-600 dark:text-gray-400">
          ...
          <p>
            {`This year I joined Rabobank as a lead frontend developer. In my new
            role I'll be helping others find their way around the complex
            environment of the Rabobank. I hope to create a sense of community,
            so that developers can more easily ask colleagues for help, do code
            reviews, share code snippets and generally learn from each other.
            Of course I will still be coding myself as well. I wouldn't want to miss that!`}
          </p>
        </article>
