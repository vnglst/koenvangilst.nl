  ...
  return (
    ...
    >
      <article className="flex flex-col items-start justify-center max-w-2xl mx-auto mb-16">
        ...
        <p className="mb-4 text-gray-600 dark:text-gray-400">
          {`I enjoy working in a multidisciplinary team and I tend to be focused on shipping features either enhancing or improving the user experience. I'm teamplayer that likes to help others and the teamm succeed and become better at their job.`}
        </p>
