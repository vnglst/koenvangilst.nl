...
export default function Blog({
  ...
  return (
    <Container
      ...
      description="I've been a freelance web developer since 2013 and have been involved in all sorts of projects. Here you'll find some of my most recent clients."
    >
