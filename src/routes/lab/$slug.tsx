    ...
    return {
      meta: [
        ...
        ...(ogImage
          ? [
              {
                property: 'og:url',
                content: `https://koenvangilst.nl/lab/${loaderData!.slug}`
              },
      ...
      links: loaderData
        ? [
            {
              rel: 'canonical',
              href: `https://koenvangilst.nl/lab/${loaderData.slug}`
            }
          ]
        : []
    };
...
function PostPage() {
  ...
  const modules = import.meta.glob<{ default: React.ComponentType }>('../../../content/*.mdx', { eager: true });
