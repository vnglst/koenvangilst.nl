      ...
      <div className="mb-10 grid min-h-screen w-full grid-cols-1 gap-4 p-4 md:px-8 lg:grid-cols-2 2xl:grid-cols-3">
        <div className="prose dark:prose-invert my-auto p-2 md:py-6 md:pr-8">
          <p>
            ...
            Will we have a warmer more subtropical climate? Will our dykes be
            high enough? And will our economy be CO2 neutral?
          </p>
          <p>
            With this website, I want to answer these questions at a glance. So
            you can immediately see where we are now and what the prognosis is
            for the Netherlands in 2100. The graphs are based on facts and
            scientific models from well-known institutes. Where the data is as
            up to date as possible and the models correspond to the latest
            insights.
          </p>
          <p>
