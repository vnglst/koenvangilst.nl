    ...
    <Container>
      ...
      <Prose>
        <p className="mb-4 text-center">
          ...
          office. I'm using a <Link href="https://aranet4.com/">Aranet4</Link>{' '}
          and my <Link href="https://www.raspberrypi.org/">Raspberry Pi</Link>{' '}
          is reading the data on a 1 minute interval via Bluetooth. I also wrote
          a <Link href="/lab/aranet4-co2-monitor">blog post</Link> about it.
          Should the levels rise above the recommended threshold of 1000 ppm,
          don't hesitate to reach out to me on{' '}
          <Link href="https://elk.zone/hachyderm.io/@vnglst">Mastodon</Link> to
