  ...
  return (
    <Container>
      ...
      <Prose className="mb-4">
        <p>
          I'm a software engineer with a philosophy degree and a lifelong
          passion for creating software. I started programming at an early age
          using GW-Basic and Turbo Pascal, and even though I've had many more
          interests, my fascination for making computers do "cool stuff" has
          never faded. After many years as a web developer, I'm now in a
          technical leadership role helping teams build AI solutions for
          Rabobank.
        </p>
      </Prose>

      <p className="mt-8 mb-4 text-base font-bold text-gray-900 dark:text-gray-100">
        Recent articles
      </p>
          ...
          {recentArticles.map((article) => (
            ...
            >
              ...
              <Link
                ...
                href={article.url || `/lab/${article.slug}`}
              >
                {article.title}
              </Link>
            </li>
