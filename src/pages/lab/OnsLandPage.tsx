...
import { LandUseChart } from '../../../app/lab/ons-land/LandUseChart';

export function OnsLandPage() {
  return (
    <>
      <Helmet>
        <title>Ons Land | Koen van Gilst</title>
        <meta name="description" content="A data visualization project that shows the distribution land use in the Netherlands." />
      </Helmet>
      <Container>
        ...
        <Prose className="my-8">
          <p>
            ...
            fraction of the country's land, roughly 0.06% or 26.647 hectares. The color of each hexagon corresponds to
          ...
          <p>
            With growing pressure on space, how can we ensure there's room for affordable housing, nature, and
            productive agriculture? This visualization sheds light on how the Netherlands currently uses its land,
            sparking a fact-based discussion on optimizing land use for a sustainable future.
          </p>
          ...
          <p>
            ...
            visualization can be found in my website repository. For a simplified version using just an index.html
