...
export function Home() {
  useEffect(() => {
    document.title = 'Koen van Gilst - Tech Lead';
  }, []);

  return (
    <>
      <Helmet>
        <title>Koen van Gilst - Tech Lead</title>
        <meta
          name="description"
          content="Tech Lead at Rabobank with a background in philosophy and lifelong passion for programming. I focus on AI, team building, and bridging business with technology to deliver real value."
        />
      </Helmet>
      <Container>
        <Prose>
          ...
          <p>
            ...
            work done faster and with less friction. To do this I experiment with GenAI by building technical
            prototypes and collaborating closely with business stakeholders and engineers, guiding projects from initial
