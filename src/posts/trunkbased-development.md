...
image:
  ...
  showAsHeader: true
summary: >-
  Moving away from the structured Git Flow to a more continuous approach with
...
permalink: /lab/trunkbased-development/
---
...
Developing new features on short-lived feature branches could work like this:
...
<Image
  src="/static/images/mermaid1.svg"
  width="830"
  height="500"
  alt="mermaid diagram of trunk-based development"
/>

{/* 
Visit https://mermaid.live/ to update the diagram using the following code:
gitGraph
commit id: "feature 1" 
commit id: "feature 2"
...
Ideally, the deployment process is fully automated in a CI/CD pipeline. It would then be a matter of automatically deploying the latest main to production regularly.

In the early phases of a project, this might not be the case yet. In that case, you could opt for using release branches like this:

- create a branch on remote `release/2022-09-22`
- CI/CD triggers deploy to acceptance
- tag commit on the release branch → deployment to production

In a diagram this would look like:

<Image
  src="/static/images/mermaid2.svg"
  width="830"
  height="500"
  alt="mermaid diagram of trunk-based development"
/>
