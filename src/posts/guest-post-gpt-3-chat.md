...
summary: >-
  I asked ChatGPT to write a blog post about its impact on the way developers
  write code. The contents might surprise you.
tags:
  - article
  - chatgpt
  - ai
...
permalink: /lab/guest-post-gpt-3-chat/
---

<Disclaimer>
  For this blog post, I asked ChatGPT, a large language model trained by OpenAI,
  to write about its impact on the way developers work. I've not changed or
