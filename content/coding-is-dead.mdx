...
So, coming back to the original question, is this the beginning of the end of coding? What we'll see in the near future is that "coding by hand" will go away, replaced for everyone, also within large companies, by autocomplete. Next comes debugging, upgrading packages and maybe even new feature building. Our jobs as engineers will involve more reviewing, testing and iterating. And after that, if the trend continues I can now totally imagine that only few people still do the coding themselves. Software engineering will still be a (highly paid) job as I think the skills translate well into this new domain of developing software with AI, but it would mean that coding is dead.
