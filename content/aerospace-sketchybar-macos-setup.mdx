...
_Inspired by [Christopher Penkin's yabai setup](https://www.penkin.me/development/tools/productivity/configuration/2025/11/28/building-omarchy-inspired-setup-macos.html). Full config: [github.com/vnglst/dotfiles](https://github.com/vnglst/dotfiles)_
