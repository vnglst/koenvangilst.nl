...
<Disclaimer>
  Note: you can also follow along [on Github](https://github.com/vnglst/phoenix_cursors/commits/main). I've created
  waypoints after every step of the tutorial. Every waypoint is a commit on Github.
</Disclaimer>
