...
Yesterday I gave a talk at the AI Circle where I shared some vibe coded side projects[^1] and insights on working with AI — both outside of work and within a large organization. The title was "Growing a better world... together with AI", which aligns not just with Rabobank's famous slogan[^2], but also with my perspective on how we should use AI: as an exoskeleton to enhance the capabilities of our human engineers, not as a robot replacement.
