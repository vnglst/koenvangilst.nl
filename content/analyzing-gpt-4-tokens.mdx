...
```json
{
  ...
  "photoshop": {
    "type": "lang",
    "lang": "en",
    "definition": "Image editing software"
  }
}
```
...
<Image src={`/static/images/categories.png`} width={589} height={495} />
...
<Image src={`/static/images/natural-languages.png`} width={589} height={495} />
...
<Image src={`/static/images/programming-languages.png`} width={589} height={495} />
