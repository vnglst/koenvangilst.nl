...
<Image alt={``} src={`/static/screenshots/livebook-wiki-query.jpg`} width={2268} height={1714} />
...
<Image alt={``} src={`/static/screenshots/livebook1.jpg`} width={865} height={476} />
...
<Image alt={``} src={`/static/screenshots/livebook2.jpg`} width={865} height={476} />
...
<Image alt={``} src={`/static/screenshots/livebook3.jpg`} width={865} height={476} />
