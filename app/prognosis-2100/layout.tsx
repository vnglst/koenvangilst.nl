...
export default async function Layout({ children }) {
  return (
    <>
      <nav className="sticky top-0 z-20 mb-4 flex items-center justify-center gap-4 overflow-hidden bg-white p-4 text-slate-700 md:px-8 dark:bg-black dark:text-slate-300">
        <Link
          href="/prognosis-2100"
