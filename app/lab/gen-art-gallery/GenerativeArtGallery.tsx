      ...
      <div className="pointer-events-none absolute right-0 bottom-0 left-0 bg-gradient-to-t from-black/60 to-transparent p-6">
        <div className="pointer-events-auto flex justify-center">
          <a
            ...
            className="group inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/10 px-5 py-2 text-sm font-medium text-white shadow-lg shadow-black/20 backdrop-blur transition hover:border-white/40 hover:bg-white/20"
          >
