  ...
  return (
    <Container>
      <Prose>
        ...
        <p>
          These are a collection of code snippets I've used in the past and saved. They include React hooks, TypeScript
          tips, random CSS snippets and Node.js scripts.
        </p>
      </Prose>
...
function SnippetLink({ title, description, slug, logo, views, ...rest }) {
  return (
    ...
    >
      ...
      <h3 className="mt-2 text-left text-lg font-bold text-gray-900 dark:text-gray-100">{title}</h3>
