    ...
    <Container>
      <Prose>
        ...
        <ul>
          ...
          <li>Languages: JavaScript, TypeScript, Python, Elixir, HTML5, CSS3</li>
          <li>Frameworks: React, React Native, Express, Next.js, Angular, Svelte</li>
          <li>
            Tooling & Testing: react-testing-library, Webpack, Lerna, Babel, Jest, Nock, Mock Service Worker,
            Playwright, Git, Unix
          </li>
          <li>
            Knowledgeable: CI/CD, Testing, Monorepos, Single Page Apps, Accessibility, Server Side Rendering,
            Progressive Web Apps, Internationalization
          </li>
          <li>
            Services: Docker, Azure, Gitlab CI, MongoDB, Postgresql, Google Tag Manager, Heroku, AWS, Google Cloud,
            Jira, Sentry
          </li>
        </ul>
